...
let deleteBtn = document.getElementById('annonce-delete_btn');
let confirmDelete = document.getElementById('annonce-confirm_delete');
let cancelBtn = document.getElementById('annonce-answer-delete_no');
